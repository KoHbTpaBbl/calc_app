...
class _CalculatorViewState extends State<CalculatorView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.black54,
          title: const Text('Converter', style: TextStyle(color: Colors.white38)), // Your existing title
          
          actions: <Widget>[
            IconButton(
              icon: const Icon(Icons.swap_horiz), // Choose an icon that represents the conversion feature
              onPressed: () {
                // Navigate to the KmToMileConverter screen
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => KmToMileConverter()));
              },
            ),
          ],
        ),
